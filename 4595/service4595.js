...
webServer.use('/service4595', express.static(path.join(__dirname, 'public/dist/postman')));
...
webServer.listen(PORT, () => log(LOG_FILE_NAME, `---web server 4595: running on port ${PORT}---`));